...
namespace WEB_153504_Gaikevich.API.Controllers
{
    ...
    [ApiController]
    public class СategoriesController : ControllerBase
    {
        private readonly AppDbContext _context;
        private readonly ICategoryService _categoryService;

        public СategoriesController(AppDbContext context, ICategoryService categoryService)
        {
